...
a1=double(tr(p,:)'); %inputting our first test row for the number 8
a2=W1*a1 + b1;
a2=arrayfun(f,a2);
a3=W2*a2 + b2;
a3=arrayfun(f,a3);
...
tar=zeros(1,10)';
tar(t,1)=1;      % our target is 0's in all rows with a one in the 9th row corresponding to number 8 (bc list starts w/ 0)
error=abs(tar-a4);    
